...
class DeFiScan {
  ...
  Future<dynamic> getAccountBalance(String baseURL, String address, String apiKey) async {
    NetworkHelper networkHelper = NetworkHelper(
  ...
  Future<dynamic> getAccountTxn(String baseURL, String address, [String apiKey = 'YourApiKeyToken']) async {
    NetworkHelper networkHelper = NetworkHelper(
